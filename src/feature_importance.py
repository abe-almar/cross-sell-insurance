...
def extract_feature_importance(pipeline, X_train, numeric_columns, categorical_columns, binary_columns):
    ...
    cat_features = pipeline.named_steps['feature_processing'].transformers_[1][1]['onehot'].get_feature_names_out(categorical_columns)
